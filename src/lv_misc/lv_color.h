                                                                 ...
                                                                 lv_color_t * res_color, lv_opa_t * res_opa)
{
    ...
    /*Both colors have alpha. Expensive calculation need to be applied*/
        ...
        static lv_color_t fg_color_save; fg_color_save.full = 0;
        static lv_color_t bg_color_save; bg_color_save.full = 0;
        static lv_color_t res_color_saved; res_color_saved.full = 0;
